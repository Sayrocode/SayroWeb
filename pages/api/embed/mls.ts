...
function injectCustomGallery(html: string): string {
  const css = `\n<style id=\"embed-gallery-css\">\n  .eb-embed-gallery{ width:100%; background:#fff; }\n  .eb-embed-gallery .eg-main{ position:relative; width:100%; background:#000; display:flex; align-items:center; justify-content:center; max-height:clamp(240px,56vh,640px); }\n  .eb-embed-gallery .eg-main img{ max-width:100%; max-height:100%; width:auto; height:auto; display:block; object-fit:contain; }\n  .eb-embed-gallery .eg-thumbs{ display:flex; gap:8px; overflow-x:auto; padding:10px 4px; background:#f7f7f7; }\n  .eb-embed-gallery .eg-thumbs button{ border:2px solid transparent; padding:0; background:none; border-radius:6px; cursor:pointer; flex:0 0 auto; }\n  .eb-embed-gallery .eg-thumbs button.active{ border-color:#0E3B30; }\n  .eb-embed-gallery .eg-thumbs img{ display:block; height:72px; width:auto; border-radius:4px; }\n  /* Fallback por si el slider original no se reemplaza */\n  .royal-image-slideshow, .royal-image-slideshow .rsOverflow, .royal-image-slideshow .rsContainer{ height:auto !important; }\n  img.rsMainSlideImage{ width:100% !important; height:auto !important; max-height:clamp(240px,56vh,640px) !important; object-fit:contain !important; }\n</style>\n`;
